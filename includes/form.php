<section id="contact" style="padding: 120px 0; background: var(--bg-white);">
    <div class="container">
        <div class="section-header reveal-up">
            ...
            <p style="color: var(--text-muted); max-width: 600px; margin: 15px auto 0;">Provide us with some details about your project, and our expert will get back to you promptly to schedule an on-site assessment.</p>
        </div>
