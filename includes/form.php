<section id="contact" style="padding: 120px 0; background: var(--bg-white);">
    <div class="container">
        <div class="section-header reveal-up">
            ...
            <p style="color: var(--text-muted); max-width: 600px; margin: 15px auto 0;">Provide us with some details
                about your project, and our expert will get back to you promptly to schedule an on-site assessment.</p>
        </div>

        <div class="reveal-up"
            style="max-width: 650px; margin: 0 auto; background: var(--bg-cream); padding: 50px; border-radius: 8px; border: 1px solid var(--border-soft); box-shadow: var(--shadow-soft);">
            ...
            <form action="/process-quote.php" method="POST" style="display: grid; gap: 20px;">
                ...
                <textarea name="message"
                    placeholder="Describe the job (e.g., Tree location, size, access restrictions)..." rows="4"
                ...
                <div class="cf-turnstile" data-sitekey="0x4AAAAAAEqhOZfBH73eZEX-" data-action="tree_quote"
                    data-theme="auto" data-size="flexible" data-appearance="interaction-only">
                </div>
                <button type="submit" class="btn-primary" style="width: 100%; font-size: 1rem; padding: 18px;">Submit
                    Request</button>
            </form>
        </div>
    </div>
